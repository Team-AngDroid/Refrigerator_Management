...
enum class FoodTypeFeatures(@DrawableRes val imageRes: Int) {
    ...
    사과(R.drawable.apple), 배(R.drawable.pear), 귤(R.drawable.tangerine), 바나나(R.drawable.banana),
    오렌지(R.drawable.orange), 포도(R.drawable.grape), 망고(R.drawable.mango), 키위(R.drawable.kiwi),
