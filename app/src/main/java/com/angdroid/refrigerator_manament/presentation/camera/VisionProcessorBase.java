...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    private synchronized void processLatestImage(MlImage image, final GraphicOverlay graphicOverlay) {
    ...
    private synchronized void processLatestImage(ByteBuffer image, final GraphicOverlay graphicOverlay) {
        processingImage = latestImage;
        processingMetaData = latestImageMetaData;
        latestImage = null;
        latestImageMetaData = null;
    ...
    private void processImage(
        ...
        if (isMlImageEnabled(graphicOverlay.getContext())) {
            ...
            requestDetectInImage(mlImage, graphicOverlay, bitmap, /* shouldShowFps= */ true, frameStartMs)
                    .addOnSuccessListener(executor, results -> processLatestImage(mlImage, graphicOverlay));
        ...
        requestDetectInImage(
                ...
                /* shouldShowFps= */ true,
                frameStartMs)
                .addOnSuccessListener(executor, results -> processLatestImage(data, graphicOverlay));
    }
